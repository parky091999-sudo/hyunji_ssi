...
SEARCH_POOLS = {
    "생활/청소": ["스팀청소기", "무선청소기", "욕실 청소용품", "세탁조클리너"],
    "주방": ["에어프라이어", "실리콘주걱세트", "원터치밀폐용기", "과일탈수기", "냉장고정리함", "자동 소금 후추 그라인더"],
    "디지털/가전": ["미니선풍기 USB", "휴대용 선풍기", "넥밴드 선풍기", "USB 냉각패드", "소형 제습기", "휴대용 의류건조기"],
    "먹는거": ["간식 추천 쿠팡", "캐릭터 젤리", "수입 과자", "건강 견과류", "냉동 밀키트", "농장직송 과일"],
    "뷰티": ["더마 롤러", "미백 앰플", "클렌징 오일", "쿠션팩트", "두피 스케일러", "LED 마스크", "샴푸 추천"],
    "인테리어": ["무타공 선반", "자석 메모보드", "감성 무드등", "원목 쟁반", "북유럽 캔들", "건조대"],
    "수납/정리": ["서랍 칸막이", "케이블정리 클립", "신발정리대", "냉장고 수납박스", "자동센서 휴지통"],
}
