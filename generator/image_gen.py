...
_PROMPTS = [
    ...
    (
        "이 이미지의 핵심 제품을 실제 *사용 중인 순간*의 라이프스타일 컷으로 만들어줘. "
        "단순히 테이블 위에 올려둔 정물 컷 금지. 제품의 본래 용도에 맞는 실제 사용 동작이 보여야 함 — "
        "예: 유리창닦이/스퀴지 → 유리창 표면에 대고 위에서 아래로 끌어내리는 손/팔 일부 포함, "
        "주방 도구 → 도마·식재료와 함께 손이 잡고 조리 중인 모습, "
        "청소기/세제 → 바닥·세탁기 등 작업 대상 표면이 함께 보이는 구도, "
        "욕실 제품 → 화이트 톤 욕실 벽·세면대에 부착·거치된 실사용 상태, "
        "휴대 가전 → 사용자가 손에 들고 사용 중인 자연스러운 자세. "
        "사람은 손·팔·실루엣 정도까지만(얼굴 클로즈업 금지). 한국 가정의 실내 배경, 자연광. "
        "제품 자체의 형태·색상·재질·로고는 원본과 100% 동일하게 유지 — 형태 왜곡·색상 변경·신규 부품 추가 절대 금지. "
        "다음은 반드시 제거: 한국어/중국어/일본어/영어 글자, 치수·가격·설명 문구, 워터마크, "
        "비교표, 인포그래픽, 제품 위/주변 모든 텍스트. 결과는 '이 제품을 실제로 쓰고 있구나'가 한눈에 보이는 사용씬."
    ),
]
